      ...
      >
        ...
        <div className="content">
          <div className="top-content flex justify-between items-start">
            ...
            <p className="price text-xl">{`${service.attributes.price} GHS`}</p>
          </div>
          <div className="bottom-content mt-8">
            <div className="tags flex">
              {service.attributes.offer > 0 && (
                <Tag className="px-2 pt-2 pb-1 bg-blue-600 mr-3 text-sm offer border border-opacity-30 border-black">
          ...
          <div className="flex justify-end">
            ...
            <Button
              ...
              type="submit"
              className="mt-16 px-14 pt-3 pb-2 bg-black text-blue-600 self-end hover:shadow-lg focus:outline-none active:bg-opacity-70 uppercase"
            >
              Reserve
            </Button>
          </div>
