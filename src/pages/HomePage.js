      ...
      <div className="flex justify-between items-center">
        <div className="content w-1/2 lg:pr-20 text-left">
          ...
          <Link
            to="/services"
            type="button"
            className="uppercase text-xs text-white px-4 pt-4 pb-3 bg-blue-600 mt-8 outline-none shadow-lg focus:outline-none active:bg-opacity-80"
          >
            view services
          </Link>
        </div>
        <div className="image-section h-96 w-96 px-10 relative ml-10">
          <div className="rounded-full bg-blue-600 bg-opacity-40 h-64 w-64 absolute top-0 left-0" />
